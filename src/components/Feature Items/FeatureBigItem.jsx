...
import Limage from '../../assests/images/left-image.png'
import Rimage from '../../assests/images/right-image.png'
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-12 col-sm-12 align-self-center" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                            <img src={Limage} class="rounded img-fluid d-block mx-auto" alt="App" />
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                            <img src={Rimage} class="rounded img-fluid d-block mx-auto" alt="App" />
                        </div>
                    </div>
                </div>
            </section>
